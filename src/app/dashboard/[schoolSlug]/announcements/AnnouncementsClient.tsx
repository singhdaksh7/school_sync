...
export default function AnnouncementsClient({ initialAnnouncements, schoolId }: Props) {
  ...
  async function save() {
    ...
    setDialogOpen(false); setForm({ title: "", body: "" });
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <Card><CardContent className="py-20 text-center"><Megaphone className="w-10 h-10 text-gray-300 mx-auto mb-3" /><p className="text-gray-500 font-medium">No announcements yet</p></CardContent></Card>
      ) : (
                  ...
                  <div className="flex gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-2 text-xs text-gray-400">
                        <span className="flex items-center gap-1"><Calendar className="w-3 h-3" />{format(new Date(a.publishedAt), "dd MMM yyyy, h:mm a")}</span>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              <Label>Message *</Label>
              <textarea className="w-full min-h-[120px] px-3 py-2 rounded-md border border-gray-300 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Write your announcement here..." value={form.body} onChange={(e) => setForm({ ...form, body: e.target.value })} />
            </div>
          </div>
          <DialogFooter>
