...
export async function PATCH(_req: Request, { params }: { params: Promise<{ schoolId: string }> }) {
  ...
  return handleMarkAllNotificationsRead(schoolId, { recipientType: "ADMIN_STAFF", recipientId: session.user.id });
}
