...
export default function TeachersPage() {
  ...
  function openEdit(t: Teacher) {
    ...
    setForm({
      ...
      phone: t.phone || "",
      subject: t.subject || "",
      mentorSectionId: t.mentorSection?.id || "",
    });
    // Pre-select the class for the mentor section
  ...
  async function save() {
    ...
    // Show invite link if newly created teacher has one
  ...
  return (
    <div className="space-y-6">
              ...
              <CardContent className="pt-5 pb-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex gap-1">
                    ...
                    <Button variant="ghost" size="icon" onClick={() => openEdit(t)} className="h-8 w-8 text-gray-400 hover:text-blue-600">
                      <Pencil className="w-3.5 h-3.5" />
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => deleteTeacher(t.id)} className="h-8 w-8 text-gray-400 hover:text-red-600">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-3 py-2">
            ...
            {/* Class Mentor — only when editing */}
            {editing && (
              <div className="space-y-3 pt-1 border-t border-gray-100">
                ...
                {selectedClassId && selectedClassId !== "none" && (
                  <div className="space-y-1.5">
                    <Label>Section</Label>
                    <Select
                      value={form.mentorSectionId}
                      onValueChange={(v) => setForm((f) => ({ ...f, mentorSectionId: v }))}
                    >
                      <SelectTrigger>
      ...
      <Dialog open={inviteDialogOpen} onOpenChange={setInviteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Teacher Invite Link</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-2">
            <p className="text-sm text-gray-600">
              Share this link with the teacher. They will use it to set their password and access the portal.
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="max-h-80 overflow-y-auto space-y-2 py-2">
            {csvResults.map((r, i) => (
              <div
                key={i}
                className={`flex items-start justify-between px-3 py-2 rounded-lg text-sm ${
              ...
              >
                <div>
                  ...
                  {r.success && r.inviteToken && (
                    <p className="text-xs mt-0.5 opacity-75">Invite link generated</p>
                  )}
                </div>
          ...
          <p className="text-xs text-gray-400">
            {csvResults.filter((r) => r.success).length} added,{" "}
