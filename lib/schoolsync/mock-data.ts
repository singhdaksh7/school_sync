// =============================================================================
// SchoolSync — DEMO-ONLY MOCK DATA.
// =============================================================================
// This file is consumed exclusively by /app/app/api/[[...path]]/route.ts and
// powers the demo UI. DO NOT import this from any UI component. In your real
// SchoolSync codebase you should delete both this file and the demo route
// handler, and let your existing Prisma/NextAuth/REST stack serve the same
// shapes (see /app/lib/schoolsync/types.ts).
// =============================================================================

import type {
  School, Student, Teacher, Announcement, SchoolEvent, Homework, Timetable,
  MarkRow, ReportCard, Achievement, Child, AdminDashboardData, TeacherDashboardData,
  StudentDashboardData,
} from './types'

export const SCHOOLS: School[] = [
  { id: 'greenwood', name: 'Greenwood International School', short: 'Greenwood', initials: 'GW',
    tagline: 'Nurture. Grow. Thrive.', domain: 'greenwood.schoolsync.app',
    primary: '152 76% 36%', accent: '152 76% 96%', address: '12 Greenwood Lane, Bengaluru',
    students: 1284, teachers: 96 },
  { id: 'riverside', name: 'Riverside Academy', short: 'Riverside', initials: 'RA',
    tagline: 'Where curiosity flows.', domain: 'riverside.schoolsync.app',
    primary: '217 91% 50%', accent: '217 91% 96%', address: '45 River Road, Pune',
    students: 842, teachers: 64 },
  { id: 'sunrise', name: 'Sunrise Public School', short: 'Sunrise', initials: 'SP',
    tagline: 'A new day, a new beginning.', domain: 'sunrise.schoolsync.app',
    primary: '25 95% 53%', accent: '25 95% 96%', address: '8 Sunrise Avenue, Mumbai',
    students: 1612, teachers: 112 },
]
...
export const STUDENTS: Student[] = Array.from({ length: 42 }).map((_, i) => {
  const r = seed(i + 1); const r2 = seed(i + 50)
  return {
    id: `STU-${1000 + i}`,
...
export const TEACHERS: Teacher[] = Array.from({ length: 18 }).map((_, i) => {
  const r = seed(i + 100)
  return {
    id: `TCH-${200 + i}`,
...
export const ATTENDANCE_TREND = [
  { d: 'Mon', present: 92, absent: 8 }, { d: 'Tue', present: 95, absent: 5 },
  { d: 'Wed', present: 89, absent: 11 }, { d: 'Thu', present: 94, absent: 6 },
  { d: 'Fri', present: 91, absent: 9 }, { d: 'Sat', present: 88, absent: 12 },
]

export const FEES_TREND = [
  { m: 'Jan', collected: 82, pending: 18 }, { m: 'Feb', collected: 88, pending: 12 },
  { m: 'Mar', collected: 76, pending: 24 }, { m: 'Apr', collected: 92, pending: 8 },
  { m: 'May', collected: 85, pending: 15 }, { m: 'Jun', collected: 71, pending: 29 },
]

export const HOMEWORK_PIE = [
  { name: 'Submitted', value: 68 }, { name: 'Pending', value: 22 }, { name: 'Overdue', value: 10 },
]

export const MARKS_SUBJECTS: MarkRow[] = [
  { subject: 'Math', term1: 78, term2: 84 }, { subject: 'Science', term1: 82, term2: 88 },
  { subject: 'English', term1: 74, term2: 79 }, { subject: 'Social', term1: 80, term2: 76 },
  { subject: 'Hindi', term1: 72, term2: 81 }, { subject: 'CS', term1: 90, term2: 94 },
]
...
export const TEACHER_DASHBOARD: TeacherDashboardData = {
