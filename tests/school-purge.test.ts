...
vi.mock("@/lib/prisma", () => ({
  prisma: {
    ...
    libraryHistory: { findMany: vi.fn().mockResolvedValue([]), deleteMany: vi.fn() },
    libraryLoan: { findMany: vi.fn().mockResolvedValue([]), deleteMany: vi.fn() },
    libraryReservation: { findMany: vi.fn().mockResolvedValue([]), deleteMany: vi.fn() },
    libraryBookCopy: { findMany: vi.fn().mockResolvedValue([]), deleteMany: vi.fn() },
    libraryBook: { findMany: vi.fn().mockResolvedValue([]), deleteMany: vi.fn() },
    libraryPolicy: { findMany: vi.fn().mockResolvedValue([]), deleteMany: vi.fn() },
